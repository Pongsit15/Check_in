...
<html lang="en" data-bs-theme="light"><head><script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    <title>ข้อมูลตรางกิจกรรมการทำงาน
</title>
  ...
  <nav aria-label="breadcrumb">
    <br>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="e_employee.php?id=<?php echo $row['ipid']; ?>">รายละเอียดการเข้างานเช้า-บ่าย</a></li>
          <!-- <li class="breadcrumb-item"><a href="tables.php">ตรางการเข้างาน</a></li> -->
          <li class="breadcrumb-item active" aria-current="page">รายละเอียดกิจกรรมการทำงานเช้า-บ่าย</li>
