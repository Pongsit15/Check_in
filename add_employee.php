    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            ...
            <?php } ?>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="ชื่อจริง" name="firstname" aria-describedby="firstname">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="exampleLastName"
                                            placeholder="นามสกุล" name="lastname" aria-describedby="lastname">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="ชื่อเล่น" name="N_Nickname" aria-describedby="N_Nickname">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="exampleLastName"
                                            placeholder="ตำเเหน่งงาน" name="p_position" aria-describedby="p_position">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <input type="email" class="form-control form-control-user" id="exampleInputEmail"
                                        placeholder="อีเมล" name="email" aria-describedby="email">
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="ยืนยันรหัสผ่าน" name="c_password">
                                    </div>
                                </div>
                                ...
                                <a href="logout.php" class="btn btn-success btn-user btn-block">
                                    เข้าสู่ระบบ
                                </a>
                            </form>
                            <hr>
